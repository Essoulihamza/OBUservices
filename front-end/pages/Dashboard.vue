...
<template>
    <NuxtLayout>
    <section class="container px-4 mx-auto min-h-[80vh]">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 none:divide-gray-700">
                        <thead class="bg-gray-50 none:bg-gray-800">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 none:text-gray-400">Price</th>
